    ...
    ({name, path: inputPath, globalVariableName}): RollupOptions[] => {
      ...
      > = {
        esm: {
          input: inputPath,
          output: {
            file: outputOptions.esm.file ?? `./dist/calendar-io.${name}.esm.js`,
            format: 'esm',
          },
        ...
        mjs: {
          input: inputPath,
          output: {
            file: outputOptions.mjs.file ?? `./dist/calendar-io.${name}.mjs`,
            format: 'esm',
          },
        ...
        cjs: {
          ...
          output: {
            ...
            file: outputOptions.cjs.file ?? `./dist/calendar-io.${name}.cjs`,
        ...
        umd: [
          {
            ...
            output: {
              name: globalVariableName,
              file:
                outputOptions.umd.file ?? `./dist/calendar-io.${name}.umd.js`,
              format: 'umd',
          ...
          },
          {
            ...
            output: {
              ...
              file:
                ...
                `./dist/calendar-io.${name}.umd.min.js`,
              format: 'umd',
              globals: outputOptions.umd.globals,
            },
            external: outputOptions.umd.external,
        ...
        browser: [
          {
            ...
            output: {
              file:
                ...
                `./dist/calendar-io.${name}.browser.mjs`,
              format: 'esm',
            },
          ...
          },
          {
            ...
            output: {
              file:
                outputOptions.browser.file ??
                `./dist/calendar-io.${name}.browser.min.mjs`,
              format: 'esm',
            },
            external: outputOptions.browser.external,
            plugins: [
